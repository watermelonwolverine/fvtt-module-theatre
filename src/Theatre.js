...
class Theatre {
	...
	constructor() {
		if (!Theatre.instance) {
			...
			this.pixi_container_factory = new _TheatrePixiContainerFactory(this)
		}
	...
	injectLeftPortrait(imgPath, portName, imgId, optAlign, emotions, remote) {
		...
		let dock = this.pixi_container_factory._createPortraitPIXIContainer(imgPath, portName, imgId, optAlign, emotions, true);
	...
	injectRightPortrait(imgPath, portName, imgId, optAlign, emotions, remote) {
		...
		let dock = this.pixi_container_factory._createPortraitPIXIContainer(imgPath, portName, imgId, optAlign, emotions, false);
		let textBox = document.createElement("div");
		// textBox class + style depends on our display mode
		switch (this.settings.theatreStyle) {
			case "lightbox":
